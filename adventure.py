...
bathroom = create_room("bathroom", "It's disgusting in here.")
classroom311 = create_room("classroom311", "There are kids working on math homework while appropriately socially distanced in here.")
##
...
create_exit(hallway, bathroom, "The bathroom-a strong odor seeps under the door.")
create_exit(bathroom, hallway, "Return to the hallway.")
create_exit(hallway, classroom311, "There is a classroom door numbered 311.")
create_exit(classroom311, hallway, "Ditch these nerds. You were never good at math anyways.")
